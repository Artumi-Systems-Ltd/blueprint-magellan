...
class ModelLexer implements Lexer
{
    ...
    private static array $dataTypes = [
        ...
        'magellanpoint' => 'magellanPoint',
        'magellanpointz' => 'magellanPointZ',
        'magellanpointm' => 'magellanPointM',
        'magellanpointzm' => 'magellanPointZM',
        'magellanlinestring' => 'magellanLineString',
        'magellanlinestringz' => 'magellanLineStringZ',
        'magellanlinestringm' => 'magellanLineStringM',
        'magellanlinestringzm' => 'magellanLineStringZM',
        'magellanpolygon' => 'magellanPolygon',
        'magellanpolygonz' => 'magellanPolygonZ',
        'magellanpolygonm' => 'magellanPolygonM',
        'magellanpolygonzm' => 'magellanPolygonZM',
        'magellanmultipoint' => 'magellanMultiPoint',
        'magellanmultipointz' => 'magellanMultiPointZ',
        'magellanmultipointm' => 'magellanMultiPointM',
        'magellanmultipointzm' => 'magellanMultiPointZM',
        'magellanmultilinestring' => 'magellanMultiLineString',
        'magellanmultilinestringz' => 'magellanMultiLineStringZ',
        'magellanmultilinestringm' => 'magellanMultiLineStringM',
        'magellanmultilinestringzm' => 'magellanMultiLineStringZM',
        'magellanmultipolygon' => 'magellanMultiPolygon',
        'magellanmultipolygonz' => 'magellanMultiPolygonZ',
        'magellanmultipolygonm' => 'magellanMultiPolygonM',
        'magellanmultipolygonzm' => 'magellanMultiPolygonZM',
        'magellangeometrycollection' => 'magellanGeometryCollection',
        'magellangeometrycollectionz' => 'magellanGeometryCollectionZ',
        'magellangeometrycollectionm' => 'magellanGeometryCollectionM',
        'magellangeometrycollectionzm' => 'magellanGeometryCollectionZM',
        'magellanbox2d' => 'magellanBox2D',
        'magellanbox3d' => 'magellanBox3D',
        'magellangeography' => 'magellanGeography',
        'magellangeometry' => 'magellanGeometry',
